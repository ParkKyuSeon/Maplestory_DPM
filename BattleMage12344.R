...
DPM12344$BattleMage[1] <- sum(na.omit(BattleMageFinalDPMwithMax)) / (403050 / 60000)
DPM12344$BattleMage[2] <- sum(na.omit(BattleMageFinalDPM)) / (403050 / 60000) - sum(na.omit(BattleMageFinalDPMwithMax)) / (403050 / 60000)
