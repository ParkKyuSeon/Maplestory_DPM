...
info <- c(360 + 3 * KaiserSpec$SkillLv, 10, 720, NA, NA, NA, NA, F) 
...
option <- factor(c("BDR", "IGR", "FDR"), levels=ASkill)
value <- c(20, ifelse(GetCoreLv(KaiserCore, "GigaSlasher")>=40, 20, 0), 2 * GetCoreLv(KaiserCore, "GigaSlasher")) 
info <- c(360 + 3 * KaiserSpec$SkillLv, 12, 720, NA, NA, NA, NA, F) 
info <- data.frame(AInfo, info) 
colnames(info) <- c("option", "value")
...
info <- c(500 + 8 * GetCoreLv(KaiserCore, "DracoSlasher"), 18, 720, NA, 5, T, F, F) 
info <- data.frame(AInfo, info) 
colnames(info) <- c("option", "value")
...
option <- factor(c("BDR", "IGR", "FDR"), levels=ASkill)
value <- c(20, IGRCalc(c(50, ifelse(GetCoreLv(KaiserCore, "GigaSlasher")>=40, 20, 0))), 2 * GetCoreLv(KaiserCore, "GigaSlasher")) 
info <- c(500 + 8 * GetCoreLv(KaiserCore, "DracoSlasher"), 22, 720, NA, 5, T, F, F) 
info <- data.frame(AInfo, info) 
colnames(info) <- c("option", "value")
...
info <- c(450 + 5 * KaiserSpec$SkillLv, 20, 30, NA, 10, T, T, F) 
info <- data.frame(AInfo, info) 
colnames(info) <- c("option", "value")
...
option <- factor(c("IGR", "FDR"), levels=ASkill)
value <- c(ifelse(GetCoreLv(KaiserCore, "WillofSword")>=40, 20, 0), 2 * GetCoreLv(KaiserCore, "WillofSword")) 
info <- c(450 + 5 * KaiserSpec$SkillLv, 25, 30, NA, 10, T, T, F) 
info <- data.frame(AInfo, info) 
colnames(info) <- c("option", "value")
...
info <- c(300 + 4 * KaiserSpec$SkillLv, 8, 1020, NA, 20 - KaiserSpec$SkillLv, T, T, F) 
info <- data.frame(AInfo, info) 
colnames(info) <- c("option", "value")
...
option <- factor(c("IGR", "FDR"), levels=ASkill)
value <- c(ifelse(GetCoreLv(KaiserCore, "InfernalBreath")>=40, 20, 0), 2 * GetCoreLv(KaiserCore, "InfernalBreath")) 
info <- c(200 + 3 * KaiserSpec$SkillLv, 2, 0, 1200, 20 - KaiserSpec$SkillLv, T, T, F) 
info <- data.frame(AInfo, info) 
colnames(info) <- c("option", "value")
...
option <- factor(levels=ASkill)
value <- c() 
info <- c(375 + 15 * GetCoreLv(KaiserCore, "DragonBlaze"), 6, 0, 270, 120, T, F, F) 
info <- data.frame(AInfo, info) 
colnames(info) <- c("option", "value")
...
option <- factor(levels=ASkill)
value <- c() 
info <- c(450 + 18 * GetCoreLv(KaiserCore, "DragonBlaze"), 6, 0, NA, 3.6, F, F, F) 
info <- data.frame(AInfo, info) 
colnames(info) <- c("option", "value")
