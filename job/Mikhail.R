...
option <- factor(levels=ASkill)
value <- c()
info <- c(430 + 18 * GetCoreLv(MikhailCore, "SwordofSoulLight"), 12, 810, NA, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(levels=ASkill)
value <- c()
info <- c(945 + 37 * GetCoreLv(MikhailCore, "SwordofSoulLight"), 12, 930, 66, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
