...
info <- c(306, 4, 660, NA, NA, NA, NA, F)
...
info <- c(105 + 45 + 222 + 7 * LaraSpec$PSkillLv, 3 * 0.7, 0, NA, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
info <- c(215 + 120 + 295, 5, 0, NA, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(c("BDR", "IGR", "FDR"), levels=ASkill)
value <- c(25 + floor(LaraSpec$SummonedDuration / 2), IGRCalc(c(15, ifelse(GetCoreLv(LaraCore, "EarthVeinEruption")>=40, 20, 0))), 2 * GetCoreLv(LaraCore, "EarthVeinEruption"))
info <- c(63 + 35 + 218, 5, 0, NA, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(c("BDR", "IGR", "FDR"), levels=ASkill)
value <- c(25 + floor(LaraSpec$SummonedDuration / 2), IGRCalc(c(15, ifelse(GetCoreLv(LaraCore, "EarthVeinEruption")>=40, 20, 0))), 2 * GetCoreLv(LaraCore, "EarthVeinEruption"))
info <- c(120 + 48 + 337, 6, 0, NA, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(c("BDR", "IGR", "FDR"), levels=ASkill)
value <- c(25 + floor(LaraSpec$SummonedDuration / 2), IGRCalc(c(15, ifelse(GetCoreLv(LaraCore, "EarthVeinEruption")>=40, 20, 0))), 2 * GetCoreLv(LaraCore, "EarthVeinEruption"))
info <- c(85 + 48 + 190, 1, 0, 1000, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(c("BDR", "IGR", "FDR"), levels=ASkill)
value <- c(25 + floor(LaraSpec$SummonedDuration / 2), IGRCalc(c(15, ifelse(GetCoreLv(LaraCore, "EarthVeinEruption")>=40, 20, 0))), 2 * GetCoreLv(LaraCore, "EarthVeinEruption"))
info <- c(75 + 48 + 233, 3, 0, NA, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(c("BDR", "IGR", "FDR"), levels=ASkill)
value <- c(25 + floor(LaraSpec$SummonedDuration / 2), IGRCalc(c(15, ifelse(GetCoreLv(LaraCore, "EarthVeinEruption")>=40, 20, 0))), 2 * GetCoreLv(LaraCore, "EarthVeinEruption"))
info <- c((75 + 48 + 233) * 0.9, 3 * 4, 0, NA, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
info <- c(55 + 75 + 230 + 7 * LaraSpec$PSkillLv, 1, 510, 2000, NA, NA, NA, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
info <- c(550 + 12 * LaraSpec$PSkillLv, 6, 0, 0, 2.5, F, F, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(c("BDR", "IGR", "FDR"), levels=ASkill)
value <- c(25, IGRCalc(c(15, ifelse(GetCoreLv(LaraCore, "EarthVeinAbsorb")>=40, 20, 0))), 2 * GetCoreLv(LaraCore, "EarthVeinAbsorb"))
info <- c(237 + 5 * LaraSpec$PSkillLv, 2, 0, 0, 2.5, F, F, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
...
option <- factor(c("BDR", "IGR", "FDR"), levels=ASkill)
value <- c(25, IGRCalc(c(15, ifelse(GetCoreLv(LaraCore, "EarthVeinAbsorb")>=40, 20, 0))), 2 * GetCoreLv(LaraCore, "EarthVeinAbsorb"))
info <- c(220 + 5 * LaraSpec$PSkillLv, 5 * 6, 0, 0, 2.5, F, F, F)
info <- data.frame(AInfo, info)
colnames(info) <- c("option", "value")
