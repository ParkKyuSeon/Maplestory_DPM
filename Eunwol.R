...
value <- c(floor((0.2 + 0.02 * EunwolCore[[2]][7, 2]) * 221))
info <- c(30, 70 - floor(EunwolCore[[2]][7, 2]/5), 540, F, T, F, T)
info <- data.frame(BInfo, info)
colnames(info) <- c("option", "value")
...
info <- c(Cooldown(70 - floor(EunwolCore[[2]][7, 2]/5), T, EunwolBase$UnionChrs$CoolReduceP, EunwolBase$CoolReduce) - 30 - General$General$Serverlag, 70 - floor(EunwolCore[[2]][7, 2]/5), 0, F, T, F, F)
info <- data.frame(BInfo, info)
colnames(info) <- c("option", "value")
